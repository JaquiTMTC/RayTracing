...
L'archive contient le rapport et le code source du projet.
...
Tous les matériaux sont applicables à tous les types de volumes, mais le verre s'applique surtout aux surfaces fermées (sphère, cube).
